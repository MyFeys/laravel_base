...
<div class="layui-form-item">
    <label for="" class="layui-form-label">信息分类</label>
    <div class="layui-input-inline" style="z-index: 9999999999">
...
<div class="layui-form-item">
    <label for="" class="layui-form-label">信息标题</label>
...
<div class="layui-form-item">
    <label for="" class="layui-form-label">简略描述</label>
    <div class="layui-input-block">
...
<div class="layui-form-item">
    <label for="" class="layui-form-label">信息标签</label>
    <div class="layui-input-block">
        @foreach($tags as $tag)
