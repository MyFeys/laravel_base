...
class WaterMarkController extends Controller{
    ...
    public function srcImgInfo(){
        return getimagesize($this->srcImg);
    }
    ...
    private function waterposStr() {
        $this->x = ($this->srcImg_info[0]-$this->waterImg_info[0]);
        $this->y = $this->srcImg_info[1]-$this->waterImg_info[1] - 0;
    }
    ...
    private function waterstr() {
        ...
        $color = imagecolorallocatealpha($this->water_im,$this->fontColor[0],$this->fontColor[1],$this->fontColor[2],60);
        $color1=imagecolorallocatealpha($this->water_im,0,0,0,0);
        imagettftext($this->water_im,$this->fontSize,0,+1,$this->fontSize+1,$color1,$this->fontFile,$this->waterStr);
